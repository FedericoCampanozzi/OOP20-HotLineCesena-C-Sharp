...
{
    class BaseRoomsGeneratorFactory : IBaseRoomsGeneratorFactory
    {
        public IList<QuadraticRoom> GenerateQuadraticRoomList(
                 int wMin, int wMax,
                 int dMin, int dMax,
        ...
        public IList<RectangularRoom> GenerateRectungolarRoomList(
                 int wMin, int wMax,
                 int hMin, int hMax,
                 int dMin, int dMax,
                 int nBaseRoomsMin, int nBaseRoomsMax)
        ...
        public IList<OctagonalRoom> GenerateOctagonalRoomList(
